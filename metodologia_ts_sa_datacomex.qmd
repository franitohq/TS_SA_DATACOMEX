...
Para una mejor interpretación de las series de exportaciones e importaciones es necesario realizar un análisis de las mismas en el que se filtren las distintas contribuciones que la componen: ciclo-tendencia, estacional-calendario e irregular.
...
Anualmente, cuando se reciban los datos definitivso de la AEAT del año anterior, se realizará un analisis exahustivo donde se ientificará el modelo y se estimarán sus parámetros con los datos disponibles. 
...
El algoritmo usado es TRAMO-SEATS con la especificacion automática "RSAFull" con las siguientes modificaciones sobre la especificacion por defecto:
